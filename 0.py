...
'''
with open('file_p.txt') as ft:#读取文件，as后面加的是文件简称
	content = ft.read()
	print(content.rstrip())#.rstrip()删除空白行
'''
...
'''
#添加语句在文件中
filaname = 'programming.txt'
with open(filaname,'a') as file_object:
	file_object.write("I also love finding meaninga.\n")
